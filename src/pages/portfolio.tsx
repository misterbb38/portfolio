...
/**
 * Widget flottant avec WhatsApp et Telegram
 */
  ...
  return (
    <div className="fixed bottom-4 right-4 flex flex-col items-center space-y-2 z-50">
      ...
      <a
        ...
        className="bg-green-500 rounded-full p-3 shadow-md hover:scale-110 transition-transform"
      >
      ...
      {/* Bouton Telegram */}
      <a
        href="https://t.me/Amadybar" 
        target="_blank"
        rel="noopener noreferrer"
        className="bg-blue-500 rounded-full p-3 shadow-md hover:scale-110 transition-transform"
      >
...
const Portfolio = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 text-white">
      ...
      {/* WIDGET FLOTANT WhatsApp/Telegram */}
      <FloatingChatWidget />
    </div>
  );
};
